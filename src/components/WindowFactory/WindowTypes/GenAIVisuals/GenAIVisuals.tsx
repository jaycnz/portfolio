...
export function GenAIVisuals() {
  return (
    <div className="TEST flex flex-col p-4 space-y-4 overflow-scroll h-126">
        ...
        <p>I spent 14 days writing and developing prompt frameworks to effectively generate visual outputs in a product photoshoot/marketing context.
          <br/>            
          <br/>
            ...
            <br/>
            <a href="https://www.instagram.com/jayc.blend/" className="Link" target="_blank">Instagram</a>
        </p>
